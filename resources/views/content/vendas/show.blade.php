...
<style>
@media print {
    .layout-menu, .layout-navbar, .content-footer, .btn, .card-footer {
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <span class="badge bg-label-{{ $venda->status == 'Finalizada' ? 'success' : 'warning' }} fs-5">{{ $venda->status }}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <tr>
                            <td>
                                @if($item->produto->imagem)
                                    <img src="{{ asset('storage/' . $item->produto->imagem) }}" alt="Img" class="rounded-circle" width="40" height="40">
                                @else
                            ...
                            <td>
                                @if($item->manipulacao)
                                    <button class="btn btn-sm btn-outline-warning" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMan{{ $item->id_item_venda }}" aria-expanded="false">
                                    ...
                                    <div class="p-3 bg-lighter">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <strong>Data:</strong> {{ \Carbon\Carbon::parse($item->manipulacao->data_execucao)->format('d/m/Y H:i') }}
                                            </div>
                                            <div class="col-md-8">
